...
ouput_file = open("classifier_results.txt", "w")
...
#    for classifier in ['knn', 'logreg']:
        ...
        for seed in range(1, num_seeds+1):
            ...
            X_train = pd.read_csv("clean_data/stroke/X_train_" + technique + '_' + str(seed) + '.csv')
            X_test = pd.read_csv("clean_data/stroke/X_test_" + technique + '_' + str(seed) + '.csv')
            y_train = pd.read_csv("clean_data/stroke/y_train_" + technique + '_' + str(seed) + '.csv', header=None)
            y_test = pd.read_csv("clean_data/stroke/y_test_" + technique + '_' + str(seed) + '.csv', header=None)
            ...
            np.savetxt("proba_stroke/proba_" + technique + "_" + classifier + "_" + str(seed) + ".csv", y_proba, delimiter=",")
